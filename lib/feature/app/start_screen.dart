...
import 'package:com_russia_game_flutter_ui/feature/game/parkomat/presentation/pages/parkomat_test_plates_scree.dart';
...
class StartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> items = [
      ...
      {'title': 'Номера', 'screen': const ParkomatTestScreenScreen()},
    ];
